...
var gDefaultPage = "/default/loading";
		...
		'<div id="popupInner">' +
			'<div id="popupTitleBar">' +
				...
				'<div id="popupControls">' +
					'<img src="/res/img/icons/close_window.gif" onclick="hidePopWin(false);" id="popCloseBox" />' +
				'</div>' +
			'</div>' +
...
function showPopWin(url, width, height, returnFunc, showCloseBox, content) {
